...
# The Available Model
This model is available in the contents of the directory `Portparser_v2_model`. SInce this file is too large for Git Hub - 1.53 Gb - there it is available for download [here](https://github.com/LuceleneL/Portparser.v2/tree/main/Portparser_v2_model](https://drive.google.com/file/d/1fus6fz3XTUZIVXM58T-ygemCbuFzQnqf/view?usp=sharing).
...
- download (click [here](https://github.com/LuceleneL/Portparser.v2/tree/main/Portparser_v2_model](https://drive.google.com/file/d/1fus6fz3XTUZIVXM58T-ygemCbuFzQnqf/view?usp=sharing) and unzip the directory `Portparser_v2_model` to the same location of your Latin Pipe code file (`latinpipe_evalatin24.py`);
